public class Main {
	...
	private static final byte[][][] sBoxes = new byte[4][256][4];
	private static final byte[][] pArray = new byte[18][4]; // subkeys
	...
	public void InitState() {
		...
		for(int i =0;i<sBoxes.length;i++){
			for(int j = 0;i<sBoxes[i].length;i++)
			{
				c = pi.charAt(charIndex++);
				parsedInt = Integer.parseInt(String.valueOf(c));
	...
	public void expandKey(String salt, String key) {
